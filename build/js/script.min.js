...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : (global = global || self, factory(global.IMask = {}));
  ...
  if (suiteCardsArr.length) {
    var summarize = function () {
      ...
      for (var i = 0; i < cardTotalArr.length; i++) {
        ...
        sum += elemVal; //console.log( elemVal );
      }
    ...
    Array.prototype.forEach.call(suiteCardsArr, function (card) {
      ...
      var fieldAmout = card.querySelector('input[name="amount"]'); //console.log( fieldAmout.value );
